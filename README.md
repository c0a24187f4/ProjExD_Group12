...
### 分担追加機能
* **（担当:こた）** Shiftキー押下による自機キャラのスピードダウン機能＋EX含めた各難易度ごとの背景とBGM
* **（担当:灯油）** ボム機能（使用で敵の弾幕を一定期間一定範囲消滅させる）
* **（担当:harrrr）** アイテムドロップと自機パワーアップ機能
* **（担当:ゆかりな）** 難易度3種（EASY,NOMAL, HARD）の実装
* **（担当:半額先生）** ボス撃破後の特定コマンドによるEXステージ機能及びその内容
